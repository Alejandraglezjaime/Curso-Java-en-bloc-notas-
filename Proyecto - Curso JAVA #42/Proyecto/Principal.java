...
public class Principal extends JFrame implements ActionListener{
	...
	setDefaultCloseOperation(EXIT_ON_CLOSE);
      ...
      comboAntiguedad.addItem("365 dias de servicio");
      comboAntiguedad.addItem("730 a 2190 dias de servicio");
      comboAntiguedad.addItem("2555 dias o mas de servicio");
    ...
    public void actionPerformed(ActionEvent e) {
            ...
            if(nombreTrabajador.equals("") || AP.equals("") || AM.equals("") ||
               Departamento.equals("") || Antiguedad.equals("")){
                ...
                if(Departamento.equals("Atencion al Cliente")){
                                ...
                                if(Antiguedad.equals("365 dias de servicio")){
					textarea1.setText("\n   El trabajador " + nombreTrabajador + " " + AP + " " + AM + 
                                                          "\n   quien labora en " + Departamento + " con " + Antiguedad + 
                                                          "\n   recibe 6 dias de vacaciones.");
				}
				if(Antiguedad.equals("730 a 2190 dias de servicio")){
					textarea1.setText("\n   El trabajador " + nombreTrabajador + " " + AP + " " + AM + 
                                                          "\n   quien labora en " + Departamento + " con " + Antiguedad + 
                                                          "\n   recibe 14 dias de vacaciones.");
				}
				if(Antiguedad.equals("2555 dias o mas de servicio")){
					textarea1.setText("\n   El trabajador " + nombreTrabajador + " " + AP + " " + AM + 
                                                          "\n   quien labora en " + Departamento + " con " + Antiguedad + 
        ...
        if (e.getSource() == miRojo){
            getContentPane().setBackground(new Color(255,58,58));
        }
        if (e.getSource() == miAzul){
            getContentPane().setBackground(new Color(120,194,222));
        }
	if (e.getSource() == miMorado){
            getContentPane().setBackground(new Color(183,149,236));
        }
	...
	if (e.getSource() == miSalir){
        ...
        if (e.getSource() == miElCreador){
            ...
            JOptionPane.showMessageDialog(null,"Desarrollado por https://instagram.com/alejandra_g01j?igshid=MzNlNGNkZWQ4Mg==");
        }
    }
